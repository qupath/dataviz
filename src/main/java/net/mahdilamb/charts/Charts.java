...
final class Charts {
    ...
    private static abstract class KeyAreaFormattingImpl<K extends KeyAreaFormatting<K>> extends ChartComponent implements KeyAreaFormatting<K> {
    ...
    static final class ColorScaleFormattingImpl extends KeyAreaFormattingImpl<ColorScaleFormatting> implements ColorScaleFormatting {
    ...
    static final class LegendFormattingImpl extends KeyAreaFormattingImpl<LegendFormatting> implements LegendFormatting{
