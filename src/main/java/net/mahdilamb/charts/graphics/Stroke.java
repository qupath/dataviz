...
public class Stroke {
    ...
    public static final Stroke DASHED = new Stroke(1, new double[]{5, 1});
    public static final Stroke DOTTED = new Stroke(1, new double[]{1, 1});
    public static final Stroke DASH_DOT = new Stroke(1, new double[]{5, 1, 1, 1});
