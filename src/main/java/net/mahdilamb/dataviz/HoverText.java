...
public final class HoverText<O extends PlotData<O, PL>, PL extends PlotLayout<PL>> {
    ...
    public HoverText(final Map<String, IntFunction<?>> formatters, String join) {
        this.formatters = formatters;
        this.join = join == null ? DEFAULT_JOIN : join;
    }

    public HoverText(final Map<String, IntFunction<?>> formatters) {
        this(formatters, "\n");
    }
