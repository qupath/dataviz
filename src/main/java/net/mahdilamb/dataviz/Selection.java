    ...
    public static class Polygon extends Selection {
        ...
        public void apply(PlotLayout layout) {
            ...
            for (final PlotData<?> t : layout.data) {
                ...
                t.anySelected = false;
                @SuppressWarnings("unchecked") final List<PlotShape.Marker> n = (((List<PlotShape.Marker>) layout.markers.getOrDefault(t, RTree.emptyTree()).search(minX, minY, maxX, maxY)));
                for (final PlotShape.Marker m : n) {
