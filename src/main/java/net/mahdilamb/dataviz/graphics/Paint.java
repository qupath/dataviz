...
import net.mahdilamb.dataviz.ColorScales;
...
public class Paint {
    ...
    public static class Gradient {
        ...
        protected Gradient(final GradientType type, final Colormap colorMap, double startX, double startY, double endX, double endY) {
            this.startX = startX;
            this.startY = startY;
            this.endX = endX;
            this.endY = endY;
    ...
    protected Paint(final Gradient gradient){
        this.fill = gradient;
    }
    /**
     * Copy constructor
