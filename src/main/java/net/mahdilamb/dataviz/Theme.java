...
public final class Theme {
    ...
    public static final Theme Plotly = new Theme(
            fig -> {
                fig.setDefaultQualitativeColormap(Colormaps.get("Plotly"));
                fig.setDefaultSequentialColormap(Colormaps.get("plasma"));
                //net.mahdilamb.dataviz.fig.title.setAlignment(HAlign.LEFT);
            },
            layout -> {
