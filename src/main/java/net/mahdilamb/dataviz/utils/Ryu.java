...
/**
 * Code has been modified to quickly extract the length of a string representation of a double.
 */
...
final class Ryu {
    ...
    static final long DOUBLE_MANTISSA_MASK = (1L << DOUBLE_MANTISSA_BITS) - 1;

    static final int DOUBLE_EXPONENT_BITS = 11;
    static final int DOUBLE_EXPONENT_MASK = (1 << DOUBLE_EXPONENT_BITS) - 1;
    static final int DOUBLE_EXPONENT_BIAS = (1 << (DOUBLE_EXPONENT_BITS - 1)) - 1;
    ...
    static int lengthOfDouble(double value) {
    ...
    static int decimalLength(long v) {
