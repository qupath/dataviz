...
import static net.mahdilamb.dataviz.utils.rtree.Node2DImpl.enlargedArea;
import static net.mahdilamb.dataviz.utils.rtree.Node2DImpl.intersectionArea;
...
public class RTree<T extends Node2D> {
    ...
    private static final class UnmodifiableRTee<T extends Node2D> extends RTree<T> {
        ...
        @Override
        public T remove(double minX, double minY, double maxX, double maxY, Predicate<T> equalsFn) {
            return null;
        }
