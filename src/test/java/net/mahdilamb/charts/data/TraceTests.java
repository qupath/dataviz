package net.mahdilamb.charts.data;

import net.mahdilamb.charts.Figure;
import net.mahdilamb.charts.Line;
    ...
    */
    ...
    static void LineAndScatter8() {
        ...
        new Figure()
                ...
                .updateLayout(plot -> {
                    ...
                    plot.getXAxis().showZeroGridlines(false);
                    plot.getYAxis().showZeroGridlines(false);
                })
                .show();
    }
    ...
    static void Line8() {
        ...
        new Figure()
                ...
                .updateTraces(Scatter.class, trace -> trace.setMarkerMode(Scatter.MarkerMode.LINE_ONLY))
                .show();
    }
